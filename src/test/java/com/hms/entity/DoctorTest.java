...
class DoctorTest {
    ...
    void testPartialParameterizedConstructor() {
        Doctor doctor = new Doctor("Dr. Smith", "1980-01-01", "MBBS", "Cardiology", "smith@example.com", "1234567890", "pass123");
    ...
    void testFullParameterizedConstructor() {
        Doctor doctor = new Doctor(1, "Dr. Smith", "1980-01-01", "MBBS", "Cardiology", "smith@example.com", "1234567890", "pass123");
