...
public class DoctorLoginServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (doctor != null) {
			...
			session.setAttribute("doctorObj", doctor); // Stored in Amazon ElastiCache for Redis
			...
			session.setAttribute("errorMsg", "Invalid email or password"); // Stored in Amazon ElastiCache for Redis
